...
public class DemoTouchActivity extends Activity implements View.OnTouchListener
{
    ...
    private void init()
    {
        ...
        statusText = (TextView)findViewById(R.id.info_text_view);
        xText = (TextView)findViewById(R.id.x_text_view);
        yText = (TextView)findViewById(R.id.y_text_view);
        pText = (TextView)findViewById(R.id.p_text_view);

        velocityText = (TextView)findViewById(R.id.velocity_text_view);
        vxText = (TextView)findViewById(R.id.vx_text_view);
        vyText = (TextView)findViewById(R.id.vy_text_view);
        flingxText = (TextView)findViewById(R.id.flingx_text_view);
        flingyText = (TextView)findViewById(R.id.flingy_text_view);
